...
SYSTEM_PROMPT = (
    ...
    "in context; do not define them or restart the conversation. Interpret 'yes' as confirmation only when the previous "
    "question can be answered yes or no. If the previous question offered alternatives, 'yes' does not choose one: briefly "
    "say you are not sure which option they mean, then offer your recommendation or ask them to pick. Never claim the user "
    "chose something they did not clearly choose. Avoid turning a conversation into a long interview: ask at most one "
    "necessary question in a reply, and after a few details provide a useful summary and a concrete first step, using "
    "sensible beginner-friendly defaults for missing choices. When helping with a project, explain unfamiliar terms simply "
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    :root[data-theme="dark"] .settings-actions button,:root[data-theme="dark"] .accent-choice { background:#292930; color:#eee; border-color:#464650; }
...
<body>
  ...
  <aside class="sidebar" id="app-sidebar">
    ...
    <button class="nav-button account-button" id="account-button">♙ &nbsp; Account</button>
